...
export type AIProviderKind='mock'|'openai'|'openai_compatible'|'codex_cli'|'claude_cli';
...
export type AISettings={enabled:boolean;provider:AIProviderKind;model:string;apiBaseUrl:string;hasApiKey:boolean;interruptionMode:InterruptionMode};
